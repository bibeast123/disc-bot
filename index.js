const { Client, Intents, Interaction, CommandInteraction, MessageActionRow, MessageButton} = require('discord.js');
...
client.on('interactionCreate', async interaction => {
    ...
    if(tictactoe_state[row][col] != EMPTY){
        interaction.update({
            content: "position already selected, select another position!",
            components: makeGrid()
        }) 
        return;
    }
